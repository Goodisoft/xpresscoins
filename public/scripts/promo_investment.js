...
let amount = "";
    ...
    confirm_deposit.addEventListener('submit', (e) => {
        ...
        const transaction_id = confirm_deposit.transaction_id.value;
        const promo_id = confirm_deposit.promo_id.value;
        ...
        const data = {currency, amount, transaction_id, promo_id};

        // Post data
        fetch('/user/promo-deposit', {
